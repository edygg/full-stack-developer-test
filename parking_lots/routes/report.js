...
router.post('/start-month', passport.authenticate('bearer', { session: false }), async function (request, response, next) {
    try {
...
router.get('/resident-monthly-quota', passport.authenticate('bearer', { session: false }), async function (request, response, next) {
